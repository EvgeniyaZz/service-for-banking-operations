...
import com.github.EvgeniyaZz.bank.util.JwtUtil;
...
public class JwtSecurityConfiguration {
    ...
    public SecurityFilterChain apiFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .sessionManagement((exceptionHandling) ->
                        exceptionHandling.sessionCreationPolicy(SessionCreationPolicy.STATELESS))
